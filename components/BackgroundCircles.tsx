...
export default function BackgroundCircles({}: Props) {
  return (
    <motion.div
      ...
      className="relative flex justify-center items-center h-2 top-auto"
    >
      ...
      <div className="rounded-full border border-[#F7ABOA] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse" />
